...
class UserSkillController {
    ...
    private function get(): void {
        ...
        if (!empty($_GET['userId'])) {
            $stmt = $this->db->prepare(
                "SELECT * FROM userskill WHERE userId = :userId ORDER BY skillName"
            );
        ...
        if ($this->id) {
            $stmt = $this->db->prepare("SELECT * FROM userskill WHERE userSkillId = :id");
    ...
    private function create(): void {
        ...
        $stmt = $this->db->prepare(
            "INSERT INTO userskill (userId, skillName, source, skillLevel, certificateUrl, validatedAt)
    ...
    private function update(): void {
        ...
        if (isset($this->body['skillLevel']))     { $fields[] = 'skillLevel = :skillLevel';         $params['skillLevel']     = (int)$this->body['skillLevel']; }
