  ...
  <div class="container">
    ...
    <div class="hero">
      ...
      <div class="hero-actions">
        ...
        <button class="btn btn-ghost" id="nav-my" onclick="showPage('my')">My Participations</button>
        <button class="btn btn-ghost" id="nav-sponsors" onclick="showPage('sponsors')">💼 Sponsors</button>
      </div>
