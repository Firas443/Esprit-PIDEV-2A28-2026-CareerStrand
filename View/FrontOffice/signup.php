...
<head>
  ...
  <style>
    ...
    *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
    ...
    .brand-logo{width:72px;height:72px;object-fit:contain;display:block;padding:8px;border-radius:22px;background:#fff;border:1px solid rgba(255,255,255,.72);box-shadow:0 12px 30px rgba(0,0,0,.22);}
  ...
  <header class="site-header">
    <div class="header-inner">
      <a href="index.php" class="brand">
        <img src="images/CareerStrand_logo_mark.png" alt="CareerStrand logo" class="brand-logo">
      </a>
      <a href="index.php" class="btn btn-main">Back to Home</a>
    </div>
  </header>
