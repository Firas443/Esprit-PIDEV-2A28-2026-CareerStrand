...
require_once __DIR__ . '/../../Controller/Controcalendar.php';
...
<?php if ($action == 'list'): ?>
    <?php
    $adminSidebarCardTitle = 'Courses';
    $adminSidebarCardText = 'Gerez les cours et leurs sessions depuis le module education.';
    $adminSidebarCardHtml = '<a href="admin-courses.php" class="btn btn-soft" style="display:inline-block;margin-top:14px;font-size:13px;text-decoration:none;padding:10px 18px">Gerer les cours</a>';
    ?>
    ...
    <main class="admin-main">
        <header class="page-header">
            ...
            <div class="header-actions">
                ...
                <a class="btn btn-main" href="../FrontOffice/course.php">Front Office</a>
            </div>
        </header>
