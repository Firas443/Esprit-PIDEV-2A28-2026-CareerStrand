        ...
        <div class="ai-panel-grid">
          <div class="ai-section">
            <div class="ai-section-head">
              <h3>Top Complaint Patterns</h3>
              <p>Most frequent negative topics detected from all stored feedback.</p>
            </div>
        ...
        <div class="field">
           <label>Manager *</label>
              <select id="ef-manager" required>
                  ...
                  <?php
                  $userStmt = config::getConnexion()->query("SELECT userId, fullName FROM Users WHERE role = 'manager' ORDER BY fullName");
      ...
      <div class="field-row">
        ...
        <div class="field">
          ...
          <select id="sf-user">
              ...
              <?php
              $userStmt = config::getConnexion()->query("SELECT userId, fullName FROM Users ORDER BY fullName");
              $userOptions = $userStmt->fetchAll(PDO::FETCH_ASSOC);
              foreach ($userOptions as $userOption): ?>
                  <option value="<?= $userOption['userId'] ?>"><?= htmlspecialchars($userOption['fullName']) ?></option>
              <?php endforeach; ?>
          </select>
      </div>
      </div>
