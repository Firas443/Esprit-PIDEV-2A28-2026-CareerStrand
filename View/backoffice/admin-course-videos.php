...
<div class="admin-shell">
    <aside class="admin-sidebar">
        ...
        <nav class="nav-list">
            ...
            <a class="nav-item active" href="admin-course-videos.php"><span>Course Videos</span><span>New</span></a>
            <a class="nav-item" href="admin-calendrier.php"><span>Calendrier</span></a>
        </nav>
    </aside>
                    ...
                    <?php foreach ($videos as $i => $v): ?>
                        <div class="video-card">
                            ...
                            <video controls preload="metadata">
                                <source src="/careerstrand/<?= htmlspecialchars($vpath) ?>" type="video/mp4">
                            </video>
                            <div class="video-card-body">
                                ...
                                <div class="video-card-actions">
                                    ...
                                    <?php else: ?>
                                        <span style="font-size:11px;color:rgba(255,200,60,0.7);">⚠ Vidéo héritée de upload_video</span>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
